...
public class HitsGroup implements org.apache.thrift.TBase<HitsGroup, HitsGroup._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(HitsGroup other) {
    ...
    HitsGroup typedOther = (HitsGroup)other;

    lastComparison = Boolean.valueOf(isSetGroupValue()).compareTo(typedOther.isSetGroupValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGroupValue()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.groupValue, typedOther.groupValue);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
      ...
      if (incoming.get(2)) {
        {
          ...
          {
            Hit _elem139; // required
            _elem139 = new Hit();
            _elem139.read(iprot);
            struct.hits.add(_elem139);
          }
        }
        struct.setHitsIsSet(true);
      }
