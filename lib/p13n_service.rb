...
module P13nService
  class Client
    ...
    def chooseAll(bundle)
      send_chooseAll(bundle)
      return recv_chooseAll()
    end

    def send_chooseAll(bundle)
      send_message('chooseAll', ChooseAll_args, :bundle => bundle)
    end

    def recv_chooseAll()
      result = receive_message(ChooseAll_result)
      return result.success unless result.success.nil?
      raise result.p13nServiceException unless result.p13nServiceException.nil?
      raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'chooseAll failed: unknown result')
    end
  ...
  class Processor
    ...
    def process_chooseAll(seqid, iprot, oprot)
      args = read_args(iprot, ChooseAll_args)
      result = ChooseAll_result.new()
      begin
        result.success = @handler.chooseAll(args.bundle)
      rescue ::P13nServiceException => p13nServiceException
        result.p13nServiceException = p13nServiceException
      end
      write_result(result, oprot, 'chooseAll', seqid)
    end
  ...
  class ChooseAll_args
    include ::Thrift::Struct, ::Thrift::Struct_Union
    BUNDLE = -1

    FIELDS = {
      BUNDLE => {:type => ::Thrift::Types::STRUCT, :name => 'bundle', :class => ::ChoiceRequestBundle}
    }
  ...
  class ChooseAll_result
    include ::Thrift::Struct, ::Thrift::Struct_Union
    SUCCESS = 0
    P13NSERVICEEXCEPTION = 1

    FIELDS = {
      SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::ChoiceResponseBundle},
      P13NSERVICEEXCEPTION => {:type => ::Thrift::Types::STRUCT, :name => 'p13nServiceException', :class => ::P13nServiceException}
    }
