...
class FacetRequest
  ...
  FIELDS = {
    ...
    EVALUATE => {:type => ::Thrift::Types::BOOL, :name => 'evaluate', :default => true},
    DISPLAY => {:type => ::Thrift::Types::STRING, :name => 'display'},
    EXTRAINFO => {:type => ::Thrift::Types::MAP, :name => 'extraInfo', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::STRING}}
  }
...
class ChoiceRequestBundle
  ...
  FIELDS = {
    REQUESTS => {:type => ::Thrift::Types::LIST, :name => 'requests', :element => {:type => ::Thrift::Types::STRUCT, :class => ::ChoiceRequest}}
  }
...
class ChoiceResponseBundle
  ...
  FIELDS = {
    RESPONSES => {:type => ::Thrift::Types::LIST, :name => 'responses', :element => {:type => ::Thrift::Types::STRUCT, :class => ::ChoiceResponse}}
  }
...
class FacetResponse
  ...
  FIELDS = {
    ...
    EVALUATE => {:type => ::Thrift::Types::BOOL, :name => 'evaluate'},
    DISPLAY => {:type => ::Thrift::Types::STRING, :name => 'display'},
    NUMERICAL => {:type => ::Thrift::Types::BOOL, :name => 'numerical'},
    RANGE => {:type => ::Thrift::Types::BOOL, :name => 'range'},
    SORTORDER => {:type => ::Thrift::Types::I32, :name => 'sortOrder', :enum_class => ::FacetSortOrder},
    SORTASCENDING => {:type => ::Thrift::Types::BOOL, :name => 'sortAscending'},
    ANDSELECTEDVALUES => {:type => ::Thrift::Types::BOOL, :name => 'andSelectedValues'},
    BOUNDSONLY => {:type => ::Thrift::Types::BOOL, :name => 'boundsOnly'},
    EXTRAINFO => {:type => ::Thrift::Types::MAP, :name => 'extraInfo', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::STRING}}
  }
